...
class list_iterator {
 ...
 public:
  ...
  pointer operator->() { return node_->next_; }
...
class list_const_iterator {
 ...
 public:
  ...
  pointer operator->() const { return node_->next_; }
...
class list final {
 ...
 public:
  ...
  requires(std::same_as<T, types>&&...) list(const types&... args)
 ...
 public:
  ...
  // iterators
  iterator begin() noexcept { return iterator(head_.node_->next_); }
  ...
  iterator end() noexcept { return iterator(head_.node_); }

  const_iterator end() const noexcept { return const_iterator(head_.node_); }

  const_iterator cend() const noexcept { return const_iterator(head_.node_); }
